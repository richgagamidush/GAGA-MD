...
zokou({
  ...
  try {
    ...
    if (_0x5a2825 && _0x5a2825.length > 0x0) {
      ...
      const _0x4727f9 = await fetch("https://api.giftedtech.web.id/api/download/dlmp3?url/api/download/ytmp3?url=" + encodeURIComponent(_0x50cb1f) + "&apikey=" + "giftedtechk");
      ...
      if (_0x58c224.status === 0xc8 && _0x58c224.success) {
        ...
        _0x3460c8("Successfully downloaded by Gaga Md...");
      } else {
...
zokou({
  ...
  try {
    ...
    if (_0x3f4e2c && _0x3f4e2c.length > 0x0) {
      ...
      const _0xfef402 = await fetch("https://api.giftedtech.web.id/api/download/dlmp3?url/api/download/ytmp3?url=" + encodeURIComponent(_0x13523a) + "&apikey=" + "giftedtechk");
...
zokou({
  ...
  try {
    ...
    if (_0x14ddfc && _0x14ddfc.length > 0x0) {
      ...
      const _0x5734dd = await fetch("https://api.giftedtech.web.id/api/download/dlmp3?url/api/download/ytmp4?url=" + encodeURIComponent(_0x1b41fa) + "&apikey=" + "giftedtechk");
...
zokou({
  ...
  try {
    ...
    if (_0x5914b4 && _0x5914b4.length > 0x0) {
      ...
      const _0x1ee242 = await fetch("https://api.giftedtech.web.id/api/download/dlmp3?url/api/download/ytmp4?url=" + encodeURIComponent(_0x5225ee) + '&apikey=' + "giftedtechk");
